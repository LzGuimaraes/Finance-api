...
#include "models/PortfolioSnapshots.h"
...
class PortfolioSnapshotsRepository{
    public:
        explicit PortfolioSnapshotsRepository(drogon::orm::DbClientPtr db) : db_(db) {}
        ...
        void create(const PortfolioSnapshots& portfolioSnapshot,
